    ...
    <div class="shop-items  flex flex-wrap -m-4">
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="mahal theme" class="shop-item-image object-cover object-center w-full h-full block" src="images/mahal.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">The Rajmahal Theme</h2>
          <p class="shop-item-price mt-1">₹16000.00</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="flower" class="shop-item-image object-cover object-center w-full h-full block" src="images/flower.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">Flower Spray Theme</h2>
          <p class="shop-item-price mt-1">₹12100.15</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="moon" class="shop-item-image object-cover object-center w-full h-full block" src="images/moon.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">Moon Night Theme</h2>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="vintage" class="shop-item-image object-cover object-center w-full h-full block" src="images/vintage.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">The Vintage Theme</h2>
          <p class="shop-item-price mt-1">₹10008.40</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="decor" class="shop-item-image object-cover object-center w-full h-full block" src="images/deco.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">Fantacy Theme</h2>
          <p class="shop-item-price mt-1">₹12001.15</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" class="shop-item-image object-cover object-center w-full h-full block" src="images/nightdeco.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">Night Deco</h2>
          <p class="shop-item-price mt-1">₹12000.00</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" class="shop-item-image object-cover object-center w-full h-full block" src="images/moonshape.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">The Moon Shape</h2>
          <p class="shop-item-price mt-1">₹10800.40</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" class="shop-item-image object-cover object-center w-full h-full block" src="images/red scuf.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">The Red Scuf</h2>
          <p class="shop-item-price mt-1">₹90008.40</p>
    ...
    <div class="shop-items  flex flex-wrap -m-4">
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          ...
          <p class="shop-item-price mt-1">₹21000.15</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          ...
          <p class="shop-item-price mt-1">₹1200.00</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          ...
          <p class="shop-item-price mt-1">₹18000.40</p>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div class="mt-4">
          ...
          <p class="shop-item-price mt-1">₹5000.40</p>
