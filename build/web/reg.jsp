     ...
     <!-- header -->
       <header class="header">
           <div class=" navbar-brand navbar-header">
              <img  class="img" src="images/drag.jpeg">
...
<!-- login form end-->
      ...
      <a href="h1.jsp"><i class="fas fa-home"></i><span>Home</span></a>
        <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" 
                        ...
                        aria-expanded="false"><i class="fas fa-circle-chevron-down"></i><span>
                            Services</span>
                    </a>
      ...
      <a href="#"><i class="fas fa-info-circle"></i><span>About</span></a>
       ...
       <form class="reg"action="regdata.jsp"   >    
...
<div class="row">
  <div class="col-md-6 mb-4">
      <label class="co-form-check-label" >Country :-</label>
        <label class="co-form-check-label" >India</label>
