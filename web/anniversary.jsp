    ...
    <div class="shop-items  flex flex-wrap -m-4">
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" class="shop-item-image object-cover object-center w-full h-full block" src="images/1.jpg">
        </a>
        <div class="mt-4">
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="ecommerce" class="shop-item-image object-cover object-center w-full h-full block" src="images/">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
