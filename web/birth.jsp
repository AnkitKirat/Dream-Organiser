    ...
    <div class="shop-items  flex flex-wrap -m-4">
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="golden" class="shop-item-image object-cover object-center w-full h-full block" src="images/golden.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">The Golden Fury</h2>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="ballon" class="shop-item-image object-cover object-center w-full h-full block" src="images/ballon.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">Moon Of Balloon</h2>
      ...
      <div class="shop-item lg:w-1/4 md:w-1/2 p-4 w-full">
        <a class="block relative h-48 rounded overflow-hidden">
          <img alt="bluesea" class="shop-item-image object-cover object-center w-full h-full block" src="images/bluesea.jpeg">
        </a>
        <div class="mt-4">
          <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1">Decoration Theme</h3>
          <h2 class="shop-item-title text-gray-900 title-font text-lg font-medium">The Blue Sea </h2>
